...
func (a *LDAPAuth) AddUser(username, hash, role string) error {
	return nil
}

func (a *LDAPAuth) RemoveUser(username string) error {
	return nil
}

func (a *LDAPAuth) GetUsers() ([]providerTypes.UserView, error) {
	c, err := a.dial()
	if err != nil {
		return nil, err
	}
	...
	users := []providerTypes.UserView{}
	for _, entry := range sr.Entries {
		user := providerTypes.UserView{
			Username: entry.GetAttributeValue("name"),
			Role:     entry.GetAttributeValue("gidNumber"),
		}
...
func (a *LDAPAuth) ChangePassword(username, hash string) error {
	return nil
}

func (a *LDAPAuth) DropUsers() error {
	return nil
}

func (a *LDAPAuth) LoadUsers() error {
	return nil
}

func (a *LDAPAuth) GetRole(username string) (string, error) {
	c, err := a.dial()
	if err != nil {
		return "", err
	}
	...
	return sr.Entries[0].GetAttributeValue("ou"), nil
}

func (a *LDAPAuth) GetUser(username string) (providerTypes.UserView, error) {
	return providerTypes.UserView{}, nil
}

func (a *LDAPAuth) SetRole(username, role string) error {
	return nil
}

func (a *LDAPAuth) AddAppPassword(username, hash, role string, expire int) (string, error) {
	return "", nil
}

func (a *LDAPAuth) RevokeAppPassword(username, id string) error {
	return nil
}

func (a *LDAPAuth) GetAppPasswords(username string) ([]providerTypes.AppPasswordView, error) {
	return nil, nil
}

func (a *LDAPAuth) CleanUpRevokedExpiredAppPasswords() error {
	return nil
}

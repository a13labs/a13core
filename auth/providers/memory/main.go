...
func (a *MemoryAuthProvider) AuthenticateUser(username, password string) *providerTypes.UserView {
...
func (a *MemoryAuthProvider) AuthenticateWithAppPassword(username, password string) *providerTypes.UserView {
	if user, ok := a.users[username]; ok {
